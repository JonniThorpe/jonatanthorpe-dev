...
import { featuredProject as fp, projects } from '../data/portfolio.js'
import './Projects.css'
...
export default function Projects() {
  ...
  return (
    <Section id="projects" eyebrow="Projects" title="Projects" wide>
      ...
      <article className={`featured${expanded ? ' is-open' : ''}`}>
        ...
        <div className="featured__body">
          <p className="featured__eyebrow u-mono">Featured case study</p>
          <h3>{fp.name}</h3>
          ...
          <div id="scannet-detail" className="featured__detail" hidden={!expanded}>
            <h4 className="case__head u-mono">Problem</h4>
            <p>{fp.problem}</p>
            <h4 className="case__head u-mono">Approach</h4>
            <p>{fp.approach}</p>
            <h4 className="case__head u-mono">Debugging story</h4>
            <p>{fp.story}</p>
            <h4 className="case__head u-mono">Results</h4>
      ...
      {openProject && (
        <Modal title={openProject.name} onClose={() => setOpenProject(null)}>
          ...
          <a className="btn btn--primary" href={openProject.link.href}>
